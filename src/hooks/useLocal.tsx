...
export function useLocal() {
    ...
    const salvarLocal = async () => {
        ...
        const dto = {
            ...
            horarioAbertura: formData.horarioAbertura.toLocaleTimeString("pt-BR", { hour: '2-digit', minute: '2-digit', hour12: false }),
            horarioFechamento: formData.horarioFechamento.toLocaleTimeString("pt-BR", { hour: '2-digit', minute: '2-digit', hour12: false, }),
